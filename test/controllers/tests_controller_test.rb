...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { marks: @test.marks, name: @test.name, subject: @test.subject } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { marks: @test.marks, name: @test.name, subject: @test.subject } }
